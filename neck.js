...
//     names=document.getElementById("n12").innerHTML;
//     document.getElementById("ring_name").innerHTML=names;
// };
...
var modalImg = document.getElementById("img_model");
    ...
    price=document.getElementById("t13").innerHTML;
    document.getElementById("price_in").innerHTML=price;

    old=document.getElementById("s13").innerHTML;
    document.getElementById("old_price").innerHTML=old;
    
    names=document.getElementById("n13").innerHTML;
    document.getElementById("ring_name").innerHTML=names;
};

var img = document.getElementById("14");
img.onclick = function() {
var modalImg = document.getElementById("img_model");
    modal.style.display = "block";
    modalImg.src = this.src;

    price=document.getElementById("t14").innerHTML;
    document.getElementById("price_in").innerHTML=price;

    old=document.getElementById("s14").innerHTML;
    document.getElementById("old_price").innerHTML=old;
    
    names=document.getElementById("n14").innerHTML;
    document.getElementById("ring_name").innerHTML=names;
};
...
var modalImg = document.getElementById("img_model");
    ...
    price=document.getElementById("t15").innerHTML;
    document.getElementById("price_in").innerHTML=price;

    old=document.getElementById("s15").innerHTML;
    document.getElementById("old_price").innerHTML=old;
    
    names=document.getElementById("n15").innerHTML;
    document.getElementById("ring_name").innerHTML=names;
};

// var img = document.getElementById("16");
// img.onclick = function() {
// var modalImg = document.getElementById("img_model");
//     modal.style.display = "block";
//     modalImg.src = this.src;

//     price=document.getElementById("t16").innerHTML;
//     document.getElementById("price_in").innerHTML=price;

//     old=document.getElementById("s16").innerHTML;
//     document.getElementById("old_price").innerHTML=old;
    
//     names=document.getElementById("n16").innerHTML;
//     document.getElementById("ring_name").innerHTML=names;
// };

var img = document.getElementById("17");
img.onclick = function() {
var modalImg = document.getElementById("img_model");
    modal.style.display = "block";
    modalImg.src = this.src;

    price=document.getElementById("t17").innerHTML;
    document.getElementById("price_in").innerHTML=price;

    old=document.getElementById("s17").innerHTML;
    document.getElementById("old_price").innerHTML=old;
    
    names=document.getElementById("n17").innerHTML;
    document.getElementById("ring_name").innerHTML=names;
};

var img = document.getElementById("18");
img.onclick = function() {
var modalImg = document.getElementById("img_model");
    modal.style.display = "block";
    modalImg.src = this.src;

    price=document.getElementById("t18").innerHTML;
    document.getElementById("price_in").innerHTML=price;

    old=document.getElementById("s18").innerHTML;
    document.getElementById("old_price").innerHTML=old;

    names=document.getElementById("n18").innerHTML;
    document.getElementById("ring_name").innerHTML=names;
};

var img = document.getElementById("19");
img.onclick = function() {
var modalImg = document.getElementById("img_model");
    modal.style.display = "block";
    modalImg.src = this.src;

    price=document.getElementById("t19").innerHTML;
    document.getElementById("price_in").innerHTML=price;

    old=document.getElementById("s19").innerHTML;
    document.getElementById("old_price").innerHTML=old;

    names=document.getElementById("n19").innerHTML;
    document.getElementById("ring_name").innerHTML=names;
};

// var img = document.getElementById("20");
// img.onclick = function() {
// var modalImg = document.getElementById("img_model");
//     modal.style.display = "block";
//     modalImg.src = this.src;

//     price=document.getElementById("t20").innerHTML;
//     document.getElementById("price_in").innerHTML=price;

//     old=document.getElementById("s20").innerHTML;
//     document.getElementById("old_price").innerHTML=old;

//     names=document.getElementById("n20").innerHTML;
//     document.getElementById("ring_name").innerHTML=names;
// };
